...
fzf_configure_bindings --directory=\ee --variables=\e\cv
...
alias ca=bat
alias lf=ranger
alias vimdark="/home/shd/scripts/./nvim-switch-dark-light-themes.sh"
alias idea="/home/shd/IDE/intellij/bin/idea.sh"
set --universal zoxide_cmd cd

function custom_colorscheme
    set -U fish_color_normal normal
    set -U fish_color_command 58a358
